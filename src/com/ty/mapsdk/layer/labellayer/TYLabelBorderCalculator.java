...
public class TYLabelBorderCalculator {
	static final String TAG = TYLabelBorderCalculator.class.getSimpleName();

	private static final double DPI_SCALE = 1.0;

	private static final int FACILITY_LOGO_SIZE = 26;

	public static TYLabelBorder getFacilityLabelBorder(Point screenPoint) {
		...
		return new TYLabelBorder(xmin, xmax, ymax, ymin);
	}

	public static TYLabelBorder getTextLabelBorder(TYTextLabel textLabel,
			Point screenPoint) {
		double scale = DPI_SCALE;
		...
		return new TYLabelBorder(left, right, bottom, top);
	}
