...
class IPLARoomLayer extends GraphicsLayer {
	static final String TAG = IPLARoomLayer.class.getSimpleName();
	...
	public IPLARoomLayer(Context context, TYRenderingScheme renderingScheme,
