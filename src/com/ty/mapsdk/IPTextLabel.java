...
class IPTextLabel {
	...
	public IPTextLabel(String name, Point pos) {
		isHidden = false;
		this.position = pos;
		this.text = name;
		textLength = textPaint.measureText(name);
		textSize = new IPLabelSize(textLength, TEXT_SIZE);
	}
	...
	public IPLabelSize getTextSize() {
		return textSize;
	}

	public void setTextSize(IPLabelSize textSize) {
