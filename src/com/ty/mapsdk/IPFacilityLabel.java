...
class IPFacilityLabel {

	private static final int FACILITY_SIZE = 26;
	private static final IPLabelSize facilitySize = new IPLabelSize(
	...
	public IPFacilityLabel(int categoryID, Point pos) {
		isHighlighted = false;
		isHidden = false;
		this.position = pos;
	...
	public IPLabelSize getFacilityLabelSize() {
		return facilitySize;
	}
