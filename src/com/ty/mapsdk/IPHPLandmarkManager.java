...
class IPHPLandmarkManager {
	private static IPHPLandmarkManager landmarkManager;

	private int currentFloor = 0;
	private List<TYLandmark> allLandmarks = new ArrayList<TYLandmark>();

	private IPHPLandmarkManager() {

	}

	public static IPHPLandmarkManager sharedManager() {
		if (landmarkManager == null) {
			landmarkManager = new IPHPLandmarkManager();
		}
	...
	public void loadLandmark(TYMapInfo info) {
		...
		String path = IPHPMapFileManager.getLandmarkJsonPath(info);
