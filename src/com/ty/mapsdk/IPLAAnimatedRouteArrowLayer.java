...
class IPLAAnimatedRouteArrowLayer extends GraphicsLayer {
	static final String TAG = IPLAAnimatedRouteArrowLayer.class.getSimpleName();
	...
	public IPLAAnimatedRouteArrowLayer(Context context, TYMapView mapView) {
	...
	private void showRouteArrowForLine(Polyline line, double translation) {
		...
		for (int i = 0; i < numRoutePoints; ++i) {
			...
			IPRTRouteVector2 v = new IPRTRouteVector2(currentEnd.getX()
					- currentStart.getX(), currentEnd.getY()
					- currentStart.getY());
