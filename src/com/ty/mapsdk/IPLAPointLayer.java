...
class IPLAPointLayer extends GraphicsLayer {
	Context context;
	MarkerSymbol markerSymbol;

	public IPLAPointLayer(Context context, SpatialReference sr) {
		super();
	...
	public void loadContents(TYMapInfo info) {
		...
		String buildingDir = IPHPMapFileManager.getBuildingDir(
				info.getCityID(), info.getBuildingID());
