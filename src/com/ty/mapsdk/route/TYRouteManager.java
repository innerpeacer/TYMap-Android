...
public class TYRouteManager {
	...
	private TYRoutePointConverter routePointConverter;
	...
	public TYRouteManager(TYBuilding building, UserCredentials credential,
		...
		routePointConverter = new TYRoutePointConverter(info.getMapExtent(),
				building.getOffset());
	...
	private List<NPRouteManagerListener> listeners = new ArrayList<TYRouteManager.NPRouteManagerListener>();
