...
public class TYAssetLayer extends GraphicsLayer {
	static final String TAG = TYAssetLayer.class.getSimpleName();

	Context context;
	private TYRenderingScheme renderingScheme;

	public TYAssetLayer(Context context, TYRenderingScheme renderingScheme,
