...
class IPLAFloorLayer extends GraphicsLayer {
	static final String TAG = IPLAFloorLayer.class.getSimpleName();

	Context context;
	TYRenderingScheme renderingScheme;

	public IPLAFloorLayer(Context context, TYRenderingScheme renderingScheme,
