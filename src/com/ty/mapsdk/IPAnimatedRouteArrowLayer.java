...
class IPAnimatedRouteArrowLayer extends GraphicsLayer {
	static final String TAG = IPAnimatedRouteArrowLayer.class.getSimpleName();
	...
	public IPAnimatedRouteArrowLayer(Context context, TYMapView mapView) {
	...
	private void showRouteArrowForLine(Polyline line, double translation) {
		...
		for (int i = 0; i < numRoutePoints; ++i) {
			...
			IPRouteVector2 v = new IPRouteVector2(currentEnd.getX() - currentStart.getX(),
