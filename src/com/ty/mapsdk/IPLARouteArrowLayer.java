...
class IPLARouteArrowLayer extends GraphicsLayer {
	private static final double ARROW_INTERVAL = 0.005;

	TYMapView mapView;
	Context context;

	public IPLARouteArrowLayer(Context context, TYMapView mapView) {
	...
	private void showRouteArrowForLine(Polyline line) {
		...
		for (int i = 1; i < numRoutePoints; ++i) {
			...
			IPRTRouteVector2 v = new IPRTRouteVector2(currentEnd.getX() - currentStart.getX(),
