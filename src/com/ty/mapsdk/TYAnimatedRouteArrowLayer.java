...
import com.ty.mapsdk.route.Vector2;

class TYAnimatedRouteArrowLayer extends GraphicsLayer {
	static final String TAG = TYAnimatedRouteArrowLayer.class.getSimpleName();
	...
	public TYAnimatedRouteArrowLayer(Context context, TYMapView mapView) {
